from network_security.entities.artifact_entity import DataIngestionArtifact
from network_security.entities.artifact_entity import DataValidationArtifact
